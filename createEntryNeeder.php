<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      {
        //save to database;
        $query = "INSERT into needertable (CreatorID,FirstName,MiddleName,LastName,BloodNeeded,FullAddress,City,Region,ContactDetails,Comments) values ('$userID','$first_name','$middle_name','$last_name','$blood_needed','$full_address','$city','$region','$contact_details','$comments')";
      ...
      <form method = "POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" class = "middle-name" name = "entry-middle-name" placeholder="Enter your Middle name. Write N/A if not applicable" required>
          </div>
          <div class="input-box">
