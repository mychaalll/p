  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      $blood_needed = $_POST['edit-blood-needed'];
      ...
      if(!empty($first_name) && !empty($middle_name) && !empty($last_name) && !empty($blood_needed) && !empty($full_address) && !empty($city) && !empty($region) && !empty($contact_details) && !empty($comments))
      {

        //save to database;
        $query = "UPDATE `needertable` SET `FirstName`='$first_name',`MiddleName`='$middle_name',`LastName`='$last_name',`BloodNeeded`='$blood_needed',`FullAddress`='$full_address',`City`='$city',`Region`='$region',`ContactDetails`='$contact_details',`Comments`='$comments' WHERE ID = $ID";
...
<body>
  <div class="container">
    ...
    <div class="title">Edit Blood Needer Entry</div>
    <div class="content">
      <form method = "POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <select class = "choiceList" name = "edit-blood-needed">
